...
const Navbar = () => {
    return (
        <>
            <nav className="bg-white flex py-2 px-4 md:px-8 border-b border-slate-200 min-h-[68px] sticky top-0 z-20">
                <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-6 w-full">
                    <Link href={`/`} className='capitalize'>ai spend audit</Link>
                    <div 
                        ...
                        <div
                            ...
                            <button type="button" aria-controls="collapseMenu" id="toggleClose"
                                ...
                                {/* <svg xmlns="http://www.w3.org/2000/svg" className="size-4 fill-slate-900" aria-hidden="true"
                        ...
                        <ul className="flex flex-col gap-8 font-semibold text-sm text-slate-900 lg:flex-row max-lg:p-6 lg:ml-12">
                            ...
                            <li>
                                <a 
                                    className="hover:text-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">Pricing</a>
                            </li>
                            <li>
                                <a 
                                    className="hover:text-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">Testimonials</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        <Link href={`/audit`}
                            className="py-2 px-3.5 text-sm rounded-md font-semibold cursor-pointer tracking-wide text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">Get
                            started</Link>
